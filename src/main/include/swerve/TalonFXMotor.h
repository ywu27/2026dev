...
public:
    ...
    void init()
    {
        ...
        configs.TorqueCurrent.PeakForwardTorqueCurrent = 10_tps;  // Peak output of 40 amps
        configs.TorqueCurrent.PeakReverseTorqueCurrent = -10_tps; // Peak output of 40 amps
